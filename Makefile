...
dependencies.start.dev:## Start needed containers for this application in development environment.
	@docker compose -f docker-compose.dependencies.yml --project-name prosas_challenge up prosas_challenge_development_db -d --remove-orphans

dependencies.start.test:## Start needed containers for this application in test environment.
	@docker compose -f docker-compose.dependencies.yml --project-name prosas_challenge up prosas_challenge_test_db -d --remove-orphans

dependencies.stop:## Stop needed containers for this application.
	@docker compose -f docker-compose.dependencies.yml --project-name prosas_challenge stop
